...
public class CartAdapter extends ArrayAdapter<Product> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        int quantity = CartArray.quantities.get(tmpProd);
        ...
        double total = 0;
        for (Product p : prod) {
            total += p.getPrice() * CartArray.quantities.get(p);
        }
        ...
        del_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                double price = tmpProd.getPrice() * CartArray.quantities.get(tmpProd);
                CartArray.delete(tmpProd);
        ...
        inc_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CartArray.quantities.put(tmpProd, newQuantity);
